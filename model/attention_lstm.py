...
class AttentionLSTM_t(LSTM):
    ...
    def build(self, input_shape):
        ...
        self.U_a = self.add_weight(shape=(self.output_dim, self.output_dim),
                                   name='U_a',
                                   trainable=True,
        ...
        self.U_s = self.add_weight(shape=(self.output_dim, self.output_dim),
                                   name='U_s',
                                   trainable=True,
                                   initializer=self.recurrent_initializer,
                                   regularizer=self.recurrent_regularizer,
    ...
    def get_constants(self, x):
        constants = super().constants_spec
        return constants
